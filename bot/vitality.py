...
Portais de vaga respondem isso de graça: quando o anúncio sai do ar, o endpoint
de detalhe passa a devolver 404. Medido no projeto anterior:
...
**O Facebook não responde nada disso** e por isso está em `SEM_VERIFICACAO`:
post de grupo não sai do ar quando a pessoa contrata alguém. Como ele é a única
fonte ligada hoje, este módulo fica praticamente ocioso — existe para o dia em
que um portal com API for religado.
...
def verificar(source: str, source_id: str) -> Estado:

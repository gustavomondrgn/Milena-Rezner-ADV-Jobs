...
const CORES_STATUS: Record<string, { rotulo: string; cor: string; fundo: string }> = {
  sent:       { rotulo: 'Enviada',        cor: 'var(--positivo)',    fundo: 'color-mix(in srgb, var(--positivo) 12%, transparent)' },
  ...
  divulgacao: { rotulo: 'Divulgação',     cor: 'var(--texto-suave)', fundo: 'var(--superficie-2)' },
  local:      { rotulo: 'Fora da área',   cor: 'var(--atencao)',     fundo: 'color-mix(in srgb, var(--atencao) 12%, transparent)' },
  categoria:  { rotulo: 'Área desligada', cor: 'var(--atencao)',     fundo: 'color-mix(in srgb, var(--atencao) 12%, transparent)' },
...
/**
 * Bolinha de situação da demanda na origem.
 *
 * Verde = ainda aberta. Vermelha = saiu do ar, e a mensagem correspondente já
